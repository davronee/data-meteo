...
(function(h) {
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "Жадвалда хеч қандай маълумот мавжуд эмас",
            sInfo: "Жами _TOTAL_ маълумотларнинг _START_-_END_ таси жадвалда акс этмоқда",

            sInfoEmpty: " Қидирув натижаси",
            sInfoFiltered: "(жами _MAX_ маълумотлар ичидан)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "_MENU_ тасини кўрсатиш",
            sLoadingRecords: "Илтимос кутинг...",
            sProcessing: "Жараён кетмоқда...",
            sSearch: "Излаш:",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "Хеч қандай маълумот топилмади"
        },
