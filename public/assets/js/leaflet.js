    ...
    s.addEventListener = s.on, s.removeEventListener = s.clearAllEventListeners = s.off, s.addOneTimeEventListener = s.once, s.fireEvent = s.fire, s.hasEventListeners = s.listens, o.Mixin = {
        ...
        function() {
            ...
            fitBounds: function(t, e) {
                if (t = o.latLngBounds(t), !t.isValid()) throw new Error("Границы не действительны.");
            ...
            remove: function() {
                if (this._initEvents(!0), this._containerId !== this._container._leaflet_id) throw new Error("Контейнер карты используется другим экземпляром");
                try {
            ...
            createPane: function(t, e) {
                var i = "leaflet-pane" + (t ? " leaflet-" + t.replace("Панель", "") + "-pane" : ""),
            ...
            _initContainer: function(t) {
                ...
                if (!e) throw new Error("Контейнер карты не найден.");
                if (e._leaflet_id) throw new Error("Контейнер карты уже инициализирован.");
