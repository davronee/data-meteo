...
//$url = 'https://www.accuweather.com/ru/uz/tashkent/351199/daily-weather-forecast/351199?day=1';
//
...
//echo $response;
        ...
        for ($i = 1; $i <= 10; $i++) {
            $document = new Document(file_get_contents('https://www.accuweather.com/ru/uz/tashkent/351199/daily-weather-forecast/351199?day='.$i), true);
            $date = $document->find('.subnav-pagination');
