...
class MeteobotStationsSeed extends Seeder
{
    ...
    public function run()
    {
        ...
        $stations = [3231343030303336, 3231343030303337, 22070086, 22070087, 22070078, 22070089, 22070081, 3231343030303334, 3231343030303335, 3231343030303333, 22070084, 22070080, 22070088, 22070079,22070083];
