...
<li class="nav-item">
    ...
    <a href="{{ route('daily-station-info.index') }}" class="nav-link"> @lang('messages.daily-station-info-list')</a>
    <a href="{{ route('daily-station-info.create') }}" class="nav-link"> @lang('messages.daily-station-info-create')</a>
</li>
