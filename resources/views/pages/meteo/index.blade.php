...
<head>
    ...
    <link href="{{'new_meteo/assets/plugins/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css'}}"
          rel="stylesheet"/>
    ...
    <div id="header" class="app-header">
        ...
        <div class="menu">
            <marquee class="menu-link">
                <div v-for="item in current_all" class="d-inline-flex me-3"><i
                        class="me-2" :class="item.air_t >= 40 ? 'wi wi-storm-warning text-danger' : ''"></i> <span
                        class="text-theme">@{{ item.city.title }}:</span>
                    <span class="mx-2 gradus" :class="item.air_t < 0 ? '' : 'warm' ">@{{ item.air_t }}</span> <span
                        class="mx-1" :class="item.weather_code"></span>
                </div>
            </marquee>
            <div class="menu-item back-btn">
                <a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
                    <div class="menu-icon" data-toggle-class="pos-mobile-sidebar-toggled" data-toggle-target="#pos"
                         class="btn"><i class="bi bi-grid-3x3-gap nav-icon"></i></div>
                </a>
            </div>
        </div>
        <!-- END menu -->
        ...
        <div class="pos card" id="pos">
            <div class="pos-container card-body">
                ...
                <div class="pos-menu">
                    ...
                    <div class="logo">
                        <a href="#">
                            <div class="logo-img"><img src="{{asset('new_meteo/assets/img/cover/logo-meteo.svg')}}"
                                                       class="align-items-center" width="50%"></div>
                    ...
                    <div class="pos-content-container h-100 p-4" data-scrollbar="true" data-height="100%">
                        <div class="row gx-4">
                            ...
                            <div class="col-lg-12 col-xl-12 col-sm-12 mb-4 pb-4 active" data-type="ob-havo">
                                <weather-data-uzhydromet :regions="regions"  />
                                <!-- BEGIN table -->
                                <!-- END table -->
                            </div>
                            <!-- METEO XARITA -->
                            <div class="col-lg-12 col-xl-12 col-sm-12 mb-4 pb-4" data-type="meteo-map">
                                ...
                                <div class="card">
                                    ...
                                    <div class="m-1 bg-white bg-opacity-15">
                                        <iframe width="920" height="450"
                                                src="https://embed.windy.com/embed2.html?lat=41.148&lon=69.302&detailLat=41.334&detailLon=69.303&width=920&height=450&zoom=9&level=surface&overlay=ptype&product=ecmwf&menu=&message=true&marker=&calendar=24&pressure=&type=map&location=coordinates&detail=&metricWind=m%2Fs&metricTemp=%C2%B0C&radarRange=-1"
                                                style="border:0; width: 100%; height: 40rem;" allowfullscreen></iframe>
                                        <div class="list-group list-group-flush">
                                            <div class="list-group-item d-flex">
                                                <div
                                                    class="w-30px h-40px d-flex align-items-center justify-content-center">
                    ...
                    <div class="h-100 d-flex flex-column p-0">
                            ...
                            <ul class="nav nav-tabs nav-fill">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#" data-bs-toggle="tab"
                                       data-bs-target="#current_weatherTab">Ob-havo <em
                                            class="small">(real-time)</em></a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="pos-sidebar-body tab-content" data-scrollbar="true" data-height="100%">
                            ...
                            <div class="tab-pane fade h-100 show active" id="current_weatherTab">
                                <!-- BEGIN pos-order -->
                                <region-weather v-for="item in regions" :regionid="item.regionid" :days="this.days"
                                                :title="item.name_uz"/>
                                <!-- END pos-order -->
                                <!-- BEGIN pos-order -->
                                                    ...
                                                    <div class="card mb-3">
                                                        ...
                                                        <div class="card-body p-2">
                                                            ...
                                                            <div class="app-theme-list">
                                                                ...
                                                                <div class="app-theme-list-item active"><a
                                                                        href="javascript:;"
                                                            ...
                                                            <div class="app-theme-cover">
                                                                <div class="app-theme-cover-item active">
                                                                    <a href="javascript:;" class="app-theme-cover-link"
                                                                       style="background-image: url(new_meteo/assets/img/cover/cover-thumb-1.jpg);"
                                                                ...
                                                                <div class="app-theme-cover-item">
                                                                    <a href="javascript:;" class="app-theme-cover-link"
                                                                       style="background-image: url(new_meteo/assets/img/cover/cover-thumb-2.jpg);"
                                                                       data-theme-cover-class="bg-cover-2"
                                                                       data-toggle="theme-cover-selector"
                                                                       data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                                       data-bs-container="body" data-bs-title="Cover 2">&nbsp;</a>
                                                                </div>
                                                                <div class="app-theme-cover-item">
                                                                    <a href="javascript:;" class="app-theme-cover-link"
                                                                       style="background-image: url(new_meteo/assets/img/cover/cover-thumb-3.jpg);"
                                                                       data-theme-cover-class="bg-cover-3"
                                                                       data-toggle="theme-cover-selector"
                                                                       data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                                       data-bs-container="body" data-bs-title="Cover 3">&nbsp;</a>
                                                                </div>
                                                                <div class="app-theme-cover-item">
                                                                    <a href="javascript:;" class="app-theme-cover-link"
                                                                       style="background-image: url(new_meteo/assets/img/cover/cover-thumb-4.jpg);"
                                                                       data-theme-cover-class="bg-cover-4"
                                                                       data-toggle="theme-cover-selector"
                                                                       data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                                       data-bs-container="body" data-bs-title="Cover 4">&nbsp;</a>
                                                                </div>
                                                                <div class="app-theme-cover-item">
                                                                    <a href="javascript:;" class="app-theme-cover-link"
                                                                       style="background-image: url(new_meteo/assets/img/cover/cover-thumb-5.jpg);"
                                                                       data-theme-cover-class="bg-cover-5"
                                                                       data-toggle="theme-cover-selector"
                                                                       data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                                       data-bs-container="body" data-bs-title="Cover 5">&nbsp;</a>
                                                                </div>
                                                            </div>
                                                            <!-- END theme-cover -->
                                                        </div>
                        ...
                        <div class="pos-sidebar-footer">
                            <div class="mt-3">
                                <div class="d-flex logo-bottom-press">
                                    <img src="new_meteo/assets/img/cover/press-service.svg" class="align-items-center"
                                         width="50%">
                                </div>
                            </div>
                        </div>
            ...
            <div class="card pos-content">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="modal-header pos-header">
                        <div class="logo">
                            <a href="#">
                                <div class="logo-img"><i class="wi wi-day-cloudy-windy" style="font-size: 1.5rem;"></i>
                                </div>
                                        ...
                                        <div class="pos-table-booking-header">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-1">
                                                    ...
                                                    <div class="no">
                                                        <p><span class="me-1 gradus warm">4</span>...<span
                                                                class="mx-1 gradus cold">1</span></p>
                                                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-outline-theme text-white w-100px"><i
...
<script src="{{asset('new_meteo/assets/js/demo/pos-customer-order.demo.js')}}"></script>
