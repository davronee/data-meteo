...
<head>
    ...
    <!-- ================== BEGIN core-css ================== -->
    <link href="{{asset('dist1/assets/css/vendor.min.css" rel="stylesheet')}}"/>
    <link href="{{asset('dist1/assets/css/app.min.css')}}" rel="stylesheet"/>
    <!-- ================== END core-css ================== -->
    <!-- ================== BEGIN weather-css ================== -->
    <link rel="stylesheet" href="{{asset('dist1/assets/plugins/weather-icons/css/weather-icons.css')}}">
    <link rel="stylesheet" href="{{asset('dist1/assets/plugins/weather-icons/css/weather-icons-wind.css')}}">
    <!-- ================== END weather-css ================== -->
    <!-- ================== BEGIN page-css ================== -->
    <link href="{{asset('dist1/assets/plugins/tag-it/css/jquery.tagit.css')}}" rel="stylesheet"/>
    <link href="{{asset('dist1/assets/plugins/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css')}}"
          rel="stylesheet"/>
    <link href="{{asset('dist1/assets/plugins/bootstrap-daterangepicker/daterangepicker.css')}}" rel="stylesheet"/>
    <link href="{{asset('dist1/assets/plugins/bootstrap-timepicker/css/bootstrap-timepicker.min.css')}}"
          rel="stylesheet"/>
    <link href="{{asset('dist1/assets/plugins/bootstrap-slider/dist/css/bootstrap-slider.min.css')}}" rel="stylesheet"/>
    <link href="{{asset('dist1/assets/plugins/blueimp-file-upload/css/jquery.fileupload.css')}}" rel="stylesheet"/>
    <link href="{{asset('dist1/assets/plugins/summernote/dist/summernote-lite.css')}}" rel="stylesheet"/>
    <link href="{{asset('dist1/assets/plugins/spectrum-colorpicker2/dist/spectrum.min.css')}}" rel="stylesheet"/>
    <link href="{{asset('dist1/assets/plugins/select-picker/dist/picker.min.css')}}" rel="stylesheet"/>
...
{{--                        class="mx-2 gradus cold">2</span> <span class="mx-1 light-snow"></span></div>--}}
                    ...
                    <div class="row row-grid gx-0">
                        <div class="col-4">
                            <a href="#" class="dropdown-item text-decoration-none p-3 bg-none">
                                ...
                                <div class="fw-500 fs-10px text-white">ИЗА</div>
                            </a>
                        </div>
                        <div class="col-4">
                            <a href="#" class="dropdown-item text-decoration-none p-3 bg-none">
    ...
    <div id="content" class="app-content">
        <div class="d-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <select class="form-control mb-1 me-1" id="ex-forecast" v-model="days" >
        ...
        <div class="mb-md-4 mb-3 d-md-flex">
            <!-- BEGIN input-group -->
            <select class="form-control" v-model="region" @change="getcurrent">
...
{{--            </a>--}}
        ...
        <div class="row mb-3">
            <!-- BEGIN ҳарорат -->
            <div v-if="uzhydromet_current" class="col-xl-3 col-lg-6">
                <!-- BEGIN card -->
                ...
                <a href="#" class="card text-decoration-none">
                    <div class="card-body d-flex align-items-center m-5px">
                        <div class="flex-fill">
                            ...
                            <h2 class="mb-2 aqi-label-2 pm" :style="{color:current_si.color}">@{{ current_si.Si }}</h2>
            ...
            <div class="table-responsive">
                <table class="table text-nowrap table-bordered">
                    ...
                    <tr v-if="days == 1">
                        ...
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25 text-white">@{{ moment().format("DD.MM.YYYY")  }}</th>
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25 text-white">@{{ moment().add(1, 'days').format("DD.MM.YYYY")   }}</th>
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25 text-white">@{{ moment().add(2, 'days').format("DD.MM.YYYY")   }}</th>
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25 text-white">@{{ moment().add(3, 'days').format("DD.MM.YYYY")   }}</th>
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25 text-white">@{{ moment().add(4, 'days').format("DD.MM.YYYY")   }}</th>
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25 text-white">@{{ moment().add(5, 'days').format("DD.MM.YYYY")   }}</th>
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25 text-white">@{{ moment().add(6, 'days').format("DD.MM.YYYY")   }}</th>
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25 text-white">@{{ moment().add(7, 'days').format("DD.MM.YYYY")   }}</th>
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25 text-white">@{{ moment().add(8, 'days').format("DD.MM.YYYY")   }}</th>
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25 text-white">@{{ moment().add(9, 'days').format("DD.MM.YYYY")   }}</th>
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25 text-white">@{{ moment().add(10, 'days').format("DD.MM.YYYY")   }}</th>
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25 text-white">@{{ moment().add(11, 'days').format("DD.MM.YYYY")   }}</th>
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25 text-white">@{{ moment().add(12, 'days').format("DD.MM.YYYY")   }}</th>
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25 text-white">@{{ moment().add(13, 'days').format("DD.MM.YYYY")   }}</th>
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25 text-white">@{{ moment().add(14, 'days').format("DD.MM.YYYY")   }}</th>
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25 text-white">@{{ moment().add(15, 'days').format("DD.MM.YYYY")   }}</th>
                    </tr>
                    <tr v-if="days == 2">
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25"></th>
                        <th class="border-top-0 pt-2 pb-2 bg-theme bg-opacity-25 text-white">@{{ moment().add(3, 'days').format("DD.MM.YYYY")   }}</th>
                    ...
                    <tbody>
                    <tr v-if="days == 1">
                        <td class="align-middle text-capitalized fw-bold bg-gray-700 bg-opacity-50 fixed-side text-center">
                            O'zgidromet <br><small>(O'zbekiston)</small></td>
                        <td v-for="item in uzhydromet">
                            <span v-for="subday in item">
                                <span v-if="subday.day_part == 'day'">
                                    <h3>kunduzi</h3>
                                    <p><i class="wi wi-thermometer me-2"></i> <span class="me-1 gradus" :class="subday.air_t_min >= 0 ? 'warm' : ''">@{{ subday.air_t_min }}</span>...<span
                    ...
                    <tr v-if="days == 1">
                        <td class="align-middle text-capitalized fw-bold bg-gray-700 bg-opacity-50 fixed-side text-center">
                            GisMeteo <br><small>(Rossiya)</small></td>
                    ...
                    <tr v-if="days == 1">
                        <td class="align-middle text-capitalized fw-bold bg-gray-700 bg-opacity-50 fixed-side text-center">
                            Yandex <br><small>(Rossiya)</small></td>
                    ...
                    <tr v-if="days == 1">
                        <td class="align-middle text-capitalized fw-bold bg-gray-700 bg-opacity-50 fixed-side text-center">
                            Accuweather <br><small>(AQSH)</small></td>
                        <td v-for="item in uzhydromet">
                    ...
                    <tr v-if="days == 1">
                        <td class="align-middle text-capitalized fw-bold bg-gray-700 bg-opacity-50 fixed-side text-center">
                            Intellicast <br><small>(AQSH)</small></td>
                        <td v-for="item in uzhydromet">
                            <div v-for="subday in item">
                                <span v-if="subday.day_part == 'day'">
                                    <h3>kunduzi</h3>
                        ...
                        <div class="app-theme-cover">
                            <div class="app-theme-cover-item active">
                                <a href="javascript:;" class="app-theme-cover-link"
                                   style="background-image: url({{'dist1/assets/img/cover/cover-thumb-1.jpg'}});"
                            ...
                            <div class="app-theme-cover-item">
                                <a href="javascript:;" class="app-theme-cover-link"
                                   style="background-image: url({{'dist1/assets/img/cover/cover-thumb-2.jpg'}});"
                            ...
                            <div class="app-theme-cover-item">
                                <a href="javascript:;" class="app-theme-cover-link"
                                   style="background-image: url({{'dist1/assets/img/cover/cover-thumb-3.jpg'}});"
                            ...
                            <div class="app-theme-cover-item">
                                <a href="javascript:;" class="app-theme-cover-link"
                                   style="background-image: url({{'dist1/assets/img/cover/cover-thumb-4.jpg'}});"
                            ...
                            <div class="app-theme-cover-item">
                                <a href="javascript:;" class="app-theme-cover-link"
                                   style="background-image: url({{'dist1/assets/img/cover/cover-thumb-5.jpg'}});"
...
<!-- script -->
<!-- ================== BEGIN core-js ================== -->
<script src="{{asset('dist1/assets/js/vendor.min.js')}}"></script>
<script src="{{asset('dist1/assets/js/app.min.js')}}"></script>
<!-- ================== END core-js ================== -->
<!-- ================== BEGIN page-js ================== -->
<script src="{{asset('dist1/assets/plugins/highlight.js/highlight.min.js')}}"></script>
<script src="{{asset('dist1/assets/js/demo/highlightjs.demo.js')}}"></script>
<!-- ================== END page-js ================== -->
<!-- ================== BEGIN page-js ================== -->
