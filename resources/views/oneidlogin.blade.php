...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('login/admin/images/apple-touch-icon.png')}}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{asset('login/admin/images/favicon-32x32.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('login/admin/images/favicon-16x16.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('login/admin/images/favicon.ico')}}">
    <link rel="manifest" href="{{asset('login/admin/images/site.webmanifest')}}">
    <link rel="mask-icon" href="{{asset('login/admin/images/safari-pinned-tab.svg')}}" color="#5bbad5">
            ...
            <div class="row w-100 mx-0">
                <div class="col-lg-4 mx-auto">
                    ...
                    <!--  <div class="brand-logo text-right">
                            <img src="{{asset('login/admin/images/logo.svg')}}" alt="logo">
                        </div> -->
...
<script type="text/javascript" src="{{asset('login/js/axios.min.js')}}"></script>
<script type="text/javascript" src="{{asset('login/js/vue.js')}}"></script>
